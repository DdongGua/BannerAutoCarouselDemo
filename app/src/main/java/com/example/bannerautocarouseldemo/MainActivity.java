package com.example.bannerautocarouseldemo;
...
import com.example.bannerautocarouseldemo.constant.ImageList;
import com.example.bannerautocarouseldemo.util.StatusBarUtil;
import com.example.bannerautocarouseldemo.util.Utils;
import com.example.bannerautocarouseldemo.widget.BannerFlipper;
import com.example.bannerautocarouseldemo.widget.PullDownRefreshLayout;
...
public class MainActivity extends Activity implements
    ...
    public void pullUp() {
        ...
        iv_scan.setImageResource(R.mipmap.icon_scan_gray);
        iv_msg.setImageResource(R.mipmap.icon_msg_gray);
        // 上拉页面，把状态栏背景改为灰色
    ...
    public void pullDown() {
        ...
        ll_title.setVisibility(View.VISIBLE);
        iv_scan.setImageResource(R.mipmap.icon_scan_white);
        iv_msg.setImageResource(R.mipmap.icon_msg_white);
        // 下拉到顶了，把状态栏背景改为透明
